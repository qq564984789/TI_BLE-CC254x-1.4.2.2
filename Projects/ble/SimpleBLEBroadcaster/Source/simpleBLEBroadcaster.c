...
{
  simpleBLEBroadcaster_TaskID = task_id;   //osalInitTasks()·ÖÅäµÄid .ÐèÒªÓÃ»§ÈÎÎñ×Ô¶¨ÒåÒ»¸öÈ«¾Ö±äÁ¿À´±£´æ
...
uint16 SimpleBLEBroadcaster_ProcessEvent( uint8 task_id, uint16 events )
{
  ...
  if ( events & SYS_EVENT_MSG )          //´óÊÂ¼þ:ÏµÍ³ÏûÏ¢£¬ÏÂÃæ»á¶Ô´ÓÊôÓÚÕâ¸ö´óÊÂ¼þ
  {                                                     //µÄÐ¡ÊÂ¼þÔÙ½øÐÐÅÐ¶Ï
    uint8 *pMsg;
     /*¼ì²éÊÇ·ñ´ÓÏûÏ¢¶ÓÁÐÖÐÊÕµ½Êý¾Ý*/
  ...
  if ( events & SBP_START_DEVICE_EVT )   //´óÊÂ¼þ:  Æô¶¯Éè±¸Íê³É£¬ÏÂÃæ»á¶Ô´ÓÊôÓÚÕâ¸ö´óÊÂ¼þ
  {                                                          // //µÄÐ¡ÊÂ¼þÔÙ½øÐÐÅÐ¶Ï
    // Start the Device
