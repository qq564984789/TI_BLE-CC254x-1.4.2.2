...
//×¢Òâ£º Õâ¸öÏµÍ³½ÚÅÄ¶¨Ê±Æ÷µÄ²ÎÊýÊÇ²»¿ÉÒÔÐÞ¸ÄµÄ£¬
//ÕâÀïÖ»ÊÇÌá¹©Í·ÎÄ¼þ¸øÎÒÃÇÁË½âÒ»ÏÂ
//¶øÒÑ£¬ ¿âÎÄ¼þÀïÒÑ¾­Ð´ËÀÁËµÄ£¬ÎÒÃÇ²»ÄÜÐÞ¸ÄÁË¡£
/* OSAL timer defines */
#define TICK_TIME   1000   /* Timer per tick - in micro-sec */  //½ÚÅÄ¼ä¸ôÊ±¼ä:1000 US = 1ms
#define TICK_COUNT  1
#define OSAL_TIMER  HAL_TIMER_3     //  osal µÄÏµÍ³½ÚÅÄ¶¨Ê±Æ÷
