...
void osalTimeUpdate( void )
{
  ...
  //»ñÈ¡MAC¶¨Ê±Æ÷µÄ¼ÆÊýÖµ£¬Ê±¼äÒÔ625usÎªµ¥Î»
  ...
  if ( tmp != previousLLTimerTick )
  {
    ...
    while ( ticks625us > MAXCALCTICKS )
    {
      ...
      elapsedMSec += MAXCALCTICKS * 5 / 8;      //ÒÔmsÎªµ¥Î»
      remUsTicks += MAXCALCTICKS * 5 % 8;     //remUsTicksÊÇÉÏ´ÎµÄÓàÊý
    }
    ...
    if ( elapsedMSec )   //Èç¹ûÉÏ´Îµ½Õâ´ÎµÄÊ±¼ä²»ÎªÁã(ÖÁÉÙ1ms),Ôò¸üÐÂÊ±ÖÓ¼°Èí¼þ¶¨Ê±Æ÷
    {  //»»¾ä»°Ëµ£¬Ö»ÒªÁ½´ÎÖ÷Ñ­»·(osal_run_system)µÄÊ±¼ä¼ä¸ô´óÓÚ1ms,ÔòÏÂÃæÁ½¸öº¯Êý¾Í»á±»µ÷ÓÃ£¬ÕâÑùËü¾ÍÎªÓ¦ÓÃ³ÌÐòÌá¹©ÁËÒ»¸öms¶¨Ê±Æ÷
