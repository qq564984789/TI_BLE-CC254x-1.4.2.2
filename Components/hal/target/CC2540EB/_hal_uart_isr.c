/******************************************************************************
 ...
 @brief This file contains the interface to the H/W UART driver by ISR.
        «Î◊¢“‚’‚¿ÔµƒŒ Ã‚ !
         µ≤‚ : µ±ble…®√Ë∫Õ¥Æø⁄÷–∂œ∂º π”√µƒ ±∫Ú£¨¥Æø⁄ ˝æ›Ω” ’”–Œ Ã‚
...
//≤Èø¥¥Æø⁄Ω” ’«¯µ±«∞ø…“‘AVAILable µƒ◊÷Ω⁄ ˝
//“≤æÕ «ø¥Ω” ’ª∫≥Â«¯¿Ô√Ê”–∂‡…Ÿƒ⁄»›
//À„∑®: Œ≤-  ◊°£  »Áπ˚Œ≤≈‹µΩ ◊«∞√Ê¿¥¡À£¨‘Ú µº µƒŒ≤=
//HAL_UART_ISR_RX_MAX  + µ±«∞Œ≤±Í∫≈
...
// UxCSR - USART Control and Status Register.   ’‚ «USARTµƒøÿ÷∆ºƒ¥Ê∆˜
...
// UxUCR - USART UART Control Register.  ◊¢“‚:’‚Ωˆ « UART µƒøÿ÷∆ºƒ¥Ê∆˜
...
#define UTX0IE                     0x04        //¥Æø⁄0 µƒ∑¢ÀÕ÷–∂œ  πƒ‹Œª
#define UTX1IE                     0x08       //¥Æø⁄1 µƒ∑¢ÀÕ÷–∂œ  πƒ‹Œª
								    //◊¢“‚:CC2540µƒ¥Æø⁄∑¢ÀÕ°¢Ω” ’÷–∂œ
								    // «∂¿¡¢ø™¿¥µƒ£¨º˚user guide   P44/47
#define P2DIR_PRIPO                0xC0

// Incompatible redefinitions result with more than one UART driver sub-module.
#undef PxOUT                                   //#undef   :»•µÙ‘≠”–µƒ∫Í∂®“Â
#undef PxDIR
#undef PxSEL
#undef UxCSR
#undef UxUCR
...
#undef IENx
#undef IEN_BIT
#if (HAL_UART_ISR == 1)          //—°‘Ò π”√P0ªπ «P1ø⁄◊˜Œ™¥Æø⁄ π”√
#define PxOUT                      P0
#define PxIN                       P0
#define PxDIR                      P0DIR
#define PxSEL                      P0SEL
...
//Ω´ƒ≥“ªGPIOø⁄◊ˆÕ‚…Ë π”√ ±£¨¡Ω≤Ω◊ﬂ:
// 1°¢CC2430µƒ∆¨…œÕ‚…Ëæ˘ø…”≥…‰µΩGPIOµƒ¡Ω∏ˆŒª÷√¥¶£¨Œ“√«“™—°‘Ò∆‰÷–“ª∏ˆ°£
//PERCFG:∂‘”⁄“ª∏ˆÕ‚…Ë(USART °¢Timer)£¨Ω´À¸”≥…‰µΩµ⁄1Œª÷√ªπ «
//            µ⁄∂˛Œª÷√    º˚user guide   P88
// USART0 ”…”⁄—°”√ Alt-1£¨“Ú¥À“™«Â¡„(Œª”Î0->Œª”Î∑«1:ø…“‘≤ª∏ƒ±‰∆‰À˚Œª)
// USART1—°”√ Alt-2£¨“Ú¥À“™÷√Œª(ŒªªÚ1)
// 2°¢Ω´±ªÕ‚…Ë—°÷–µƒGPIOø⁄±‰≥…Õ‚…Ëπ¶ƒ‹£¨ πÕ‚…Ëπ¶ƒ‹…˙–ß   P84  ±Ì7-1
// œ¬√ÊµƒHAL_UART_Px_RX_TX∂º «∂‘ P0SEL,P1SEL…Ë÷√£¨º˚P88       
#if (HAL_UART_ISR == 1)  
...
#endif
//¥Æø⁄ ˝æ›Ω” ’ /∑¢ÀÕª∫≥Â«¯µƒµƒ ˝æ›Ω·ππ
//¥Æø⁄µƒ∂¡–¥∫Ø ˝≤ª «’Ê’˝µƒ∑¢ÀÕΩ”∏ƒ∫Ø ˝,
//À˚√«÷ª «∏∫‘Ω´ ˝ÃÓ»Îœ¬√Êµƒª∫≥Â«¯,ªÚ’ﬂ¥”ª∫≥Â«¯÷–∂¡≥ˆ
//head∫Õtail∂º «“ª∏ˆ∑ΩœÚ“∆∂Ø,µ±“∆µΩƒ©ŒªæÕªÿµΩø™Õ∑Œª÷√.
//rxBuf∫ÕtxBuf «“ª∏ˆ—≠ª∑ ˝◊È£¨¿Ô√Êƒ⁄»›”…Head°¢ Tail¡Ω∏ˆ”Œ±Í÷∏ æ
//µ±”Œ±Í÷∏ æµΩ ˝◊ÈŒ≤ ±£¨”Œ±Í±‰Œ™0£¨‘Ÿ¥”Õ∑≤øø™ º
// ∂¡–¥∫Ø ˝÷ª «Ω´ ˝ÃÓ»ÎªÚ∂¡≥ˆª∫≥Â«¯,»ª∫Û“∆∂Ø∆‰÷–“ª∏ˆ÷∏’Î..
//ƒ«√¥ ≤√¥ ±∫ÚΩ· ¯ƒÿ? æÕ «head==tail..
typedef struct
{
...
static void HalUARTInitISR(void)
{
  ...
  P2DIR &= ~P2DIR_PRIPO;
  P2DIR |= HAL_UART_PRIPO;                 //ø…ƒ‹”–∫√º∏∏ˆÕ‚…Ë”≥…‰µΩGPIO“˝Ω≈œ‡Õ¨µƒµÿ∑Ω£¨
								     //’‚ ±∫Ú£¨µΩµ◊“‘ƒƒ“ª∏ˆÕ‚…Ë∆◊˜”√ƒÿÂ …Ë÷√PRIPO
#if (HAL_UART_ISR == 1)
  PERCFG &= ~HAL_UART_PERCFG_BIT;    // Set UART0 I/O location to P0.  º˚L188
#else
  PERCFG |= HAL_UART_PERCFG_BIT;     // Set UART1 I/O location to P1.   º˚ L189
#endif
  PxSEL  |= HAL_UART_Px_RX_TX;       // Enable Tx and Rx on P1.       Ω´GPIO“˝Ω≈◊˜Œ™Õ‚…Ë“˝Ω≈
  ADCCFG &= ~HAL_UART_Px_RX_TX;      // Make sure ADC doesnt use this.
  UxCSR = CSR_MODE;                  // Mode is UART Mode.     Ω´USART …Ë÷√Œ™UART ƒ£ Ω
  UxUCR = UCR_FLUSH;                 // Flush it.    ≥ı ºµƒ ±∫Ú£¨À¢–¬¿Ô√Êµƒ ˝æ›(±‰0)
}
