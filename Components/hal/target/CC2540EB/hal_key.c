...
#define HAL_KEY_SW_6_EDGE     HAL_KEY_FALLING_EDGE     //…Ë÷√±ﬂ—ÿ÷–∂œ¿‡–Õ: …œ…˝—ÿ£¨œ¬Ωµ—ÿ
...
#else
    /* Rising/Falling edge configuratinn */
    PICTL &= ~(HAL_KEY_SW_6_EDGEBIT);    /* Clear the edge bit */  //ƒ¨»œ…œ…˝—ÿ¥•∑¢÷–∂œ
...
void HalKeyPoll (void)
{
  ...
  if (notify && (pHalKeyProcessFunction))       //µ˜”√∞¥º¸∑˛ŒÒ≥Ã–Ú(ªÿµ˜∫Ø ˝)
  {
    (pHalKeyProcessFunction) (keys, HAL_KEY_STATE_NORMAL);   //µ˜”√OnBoard_KeyCallback∫Ø ˝
