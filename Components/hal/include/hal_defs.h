...
//__LINE__ ÊÇÒ»¸öºê£¬±íÊ¾µ±Ç°´úÂëÔÚÔ´ÎÄ¼þµÄÐÐºÅ£¬ËüÊÇ´óÓÚ
// 0µÄ£¬Òò´Ë£¬ÉÏÊöÓï¾äµÈÍ¬ÓÚ#define st(x)      do { x } while (0)
//  do {  } while (0)  Í¨³£ÓÃÓÚºêÖÐ£¬ÎªµÄÊÇ±ÜÃâÈçÏÂÇé¿ö:
//  ¼ÙÉèÎÒÃÇºê¶¨Òå³ÉÕâÑù #define st(x)   x  £¬ÄÇÃ´ÎÒÃÇÔÚµ÷ÓÃ
// if (0)  st( a = b; b = c;);Ê±»á±»½âÊÍÎª  if (0)   a = b; b = c;  ÕâÑù£¬  if (0)
//¾ÍÖ»¶Ôa = bÆð×÷ÓÃÁË
