...
#define HAL_LED_MODE_BLINK   0x02    //µÆÉÁÒ»´Î
#define HAL_LED_MODE_FLASH   0x04   //µÆÁ¬ÐøÉÁË¸£¬1s Ò»´Î
#define HAL_LED_MODE_TOGGLE  0x08 //µÆµÄÊä³öÈ¡·´
...
/*
 * Blink the LED.   cnt:ÉÁË¸´ÎÊý    duty: Õ¼¿Õ±È     time  :ÖÜÆÚ(ms  )
 */ 
 //ÀýÈç  HalLedBlink(HAL_LED_1, 100, 50, 1000);      led1 Êä³ö 1hz µÄ·½²¨£¬±íÏÖÎª led1 1 ÃëÁÁÃðÒ»´Î
