...
/*
 * Write a value to the LCD    ÔÚÄ³Ò»ÐÐ½öÏÔÊ¾Êý×Ö
 */
extern void HalLcdWriteValue ( uint32 value, const uint8 radix, uint8 option);

/*
 * Write a value to the LCD  ÔÚµÚÒ»ÐÐ¡¢µÚ¶þÐÐ·Ö±ð ÏÔÊ¾line1¡¢line2×Ö·û´®
 */
extern void HalLcdWriteScreen( char *line1, char *line2 );

/*
 * Write a string followed by a value to the LCD   ÔÚÄ³Ò»ÐÐÏÔÊ¾  ×Ö·û´®+ Êý×Ö
 */
